...
const Addanaesth = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://hospital-management-backend-4.onrender.com/api/v1/anaesthesio/addnew', {
        title,
        description,
        additionalInfo,
        extraDescriptions,
      ...
      if (response.status === 201) {
        toast.success('Anaesthesia Service created successfully!');
  ...
  return (
    <div className="add-service-container">
      <Toaster />
      <h2 className="text-primary">Add Anaesthesia Service</h2>
