...
const UpdateDepartment = () => {
  ...
  const fetchDepartment = async () => {
    try {
      ...
      const response = await axios.get(`https://hospital-management-backend-3.onrender.com/api/v1/departments/${id}`);
  ...
  const handleUpdate = async (e) => {
    e.preventDefault();
    try {
      await axios.put(`https://hospital-management-backend-3.onrender.com/api/v1/departments/update/${id}`, department);
