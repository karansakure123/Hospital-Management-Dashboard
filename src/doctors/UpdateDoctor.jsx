...
const UpdateDoctor = () => {
    ...
    useEffect(() => {
        const fetchDoctor = async () => {
            try {
                const response = await axios.put(`https://hospital-management-backend-3.onrender.com/api/v1/user/doctors/update/${id}`, { withCredentials: true });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://hospital-management-backend-3.onrender.com/api/v1/user/doctors/update/${id}`, formData, {
                headers: {
