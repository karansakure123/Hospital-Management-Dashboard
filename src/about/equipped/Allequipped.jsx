...
const Allequipped = () => {
  ...
  useEffect(() => {
    const fetchEquippedData = async () => {
      try {
        const response = await axios.get('https://hospital-management-backend-4.onrender.com/api/v1/about/equipped/getall');
          ...
          <div className="button-group">
            <button
              onClick={async () => {
                ...
                try {
                  await axios.delete(`https://hospital-management-backend-4.onrender.com/api/v1/about/equipped/delete/${id}`);
